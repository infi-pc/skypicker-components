...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      js: {
        files: ['<%= config.app %>/scripts/{,*/}*.js', '!<%= config.app %>/scripts/modules/{,*/}*.js'],
        //tasks: ['jshint'],
        options: {
          livereload: true
        }
      ...
      livereload: {
        ...
        files: [
          '<%= config.app %>/{,*/}*.html',
          '.tmp/styles/{,*/}*.css',
          '../document_root/css/styl/widgets/*.css',
          '<%= config.app %>/images/{,*/}*'
        ]
      }
    },
    ...
    //  'widgets': {
    //    expand: true,
    //    cwd: '../document_root/css/styl/widgets',
    //    src: [ '**/*.styl' ],
    //    dest: '../document_root/css/styl/widgets',
    //    ext: '.css'
    //  }
    //},
